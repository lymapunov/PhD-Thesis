...
ax4.plot(t, u, linewidth=1, c='black')
ax4.set_title("Sinal de controle", fontsize=14, pad=4.5)
ax4.set_xlabel("Tempo [s]", fontsize=14)
ax4.set_ylabel("$J_2$ [$\mu$A]", fontsize=14)
ax4.set_xlim([0,90])
ax4.set_xticks([0,30,60,90],[0,30,60,90], fontsize=12)
ax4.set_ylim([-400,0])
ax4.set_yticks([-400,-300,-200,-100,0],[-400,-300,-200,-100,0], fontsize=12)

# Adjust layout to prevent overlap
plt.tight_layout()

plt.text(-121,482,r'\textbf{(a.1)}',fontsize=14)
plt.text(-13.7,482,r'\textbf{(a.2)}',fontsize=14)
plt.text(-121,5,r'\textbf{(a.3)}',fontsize=14)
