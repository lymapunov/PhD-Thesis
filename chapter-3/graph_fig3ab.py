...
ax4.set_yticks([0,1,2,3],[0,1,2,3], fontsize=12)

plt.text(-870,63*0.6,r'\textbf{(a)}',fontsize=14)
plt.text(-70,63*0.6,r'\textbf{(b)}',fontsize=14)
plt.text(-70,54.5*0.6,r'\textbf{(c)}',fontsize=14)
plt.text(-70,46.3*0.6,r'\textbf{(d)}',fontsize=14)
plt.text(-70,38.1*0.6,r'\textbf{(e)}',fontsize=14)
...
ax9.set_yticks([0,1,2,3],[0,1,2,3], fontsize=12)

plt.text(-870,30*0.6,r'\textbf{(f)}',fontsize=14)
plt.text(-70,30*0.6,r'\textbf{(g)}',fontsize=14)
plt.text(-70,21.5*0.6,r'\textbf{(h)}',fontsize=14)
plt.text(-70,13.3*0.6,r'\textbf{(i)}',fontsize=14)
plt.text(-70,5.1*0.6,r'\textbf{(j)}',fontsize=14)

plt.savefig('Amygdala_flbann-fig3ab.pdf', bbox_inches='tight')
